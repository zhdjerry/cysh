...
<body>
	...
	<div class="cf">
		...
		<div class="search-form fr cf">
			<div class="sleft">
				<input type="text" name="ideaname" class="search-input" value="<?php echo I('ideaname');?>" placeholder="请输入创意名称或者ID">
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><?php echo ($vo["idea_name"]); ?></td>
			<td><?php echo ($vo["uid_text"]); ?></td>
			<td><span><?php echo (time_format($vo["add_time"])); ?></span></td>
            <td><?php echo ($vo["check_uid_text"]); ?></td>
			<td><span><?php echo (time_format($vo["check_time"])); ?></span></td>
			<td><?php echo ($vo["status_text"]); ?></td>
			<td>
                <a href="<?php echo U('Idea/detail?id='.$vo['id']);?>">查看</a>
                <?php if(($vo["status"]) == "1"): ?><a href="<?php echo U('Idea/changeStatus?method=forbid&id='.$vo['id']);?>" class="ajax-get">禁用</a>
				<?php else: ?>
				<a href="<?php echo U('Idea/changeStatus?method=resume&id='.$vo['id']);?>" class="ajax-get">通过</a><?php endif; ?>
    ...
    //导航高亮
    highlight_subnav('<?php echo U('Idea/index');?>');
	</script>
